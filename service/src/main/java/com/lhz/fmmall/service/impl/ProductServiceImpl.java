...
import com.lhz.fmmall.dao.ProductImgMapper;
import com.lhz.fmmall.dao.ProductMapper;
import com.lhz.fmmall.dao.ProductParamsMapper;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ResultVO getProductBasicInfo(String productId) {
        ...
        criteria.andEqualTo("productStatus",1); //状态为 1 表示上架商品
